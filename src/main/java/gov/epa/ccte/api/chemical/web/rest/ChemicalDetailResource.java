...
public class ChemicalDetailResource implements ChemicalDetailApi {
    ...
    List<?> getChemicalDetails(String[] ids, String type, ChemicalDetailProjection projection) {
        return switch (projection) {
            ...
            case ntatoolkit ->
                detailService.getChemicalDetailsForBatch(ids, NtaToolkit.class, type);
            case ccdchemicaldetails ->
                detailService.getChemicalDetailsForBatch(ids, CcdChemicalDetails.class, type);
            case ccdassaydetails ->
                detailService.getCcdAssayDetails(ids);
            case compact ->
                detailService.getChemicalDetailsForBatch(ids, Compact.class, type);
        };
    }
}
